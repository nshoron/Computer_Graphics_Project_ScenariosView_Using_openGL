...
void display1_view() {
    ...
    renderBitmapString(-0.5f, 0.40f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "22-47900-2  -  ARIFUR RAHMAN");
    renderBitmapString(-0.5f, 0.30f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "22-47908-2  -  MD NAFIS ISLAM");
    renderBitmapString(-0.5f, 0.20f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "22-46180-1  -  MD. MERAZ AHASAN SHAH");
    renderBitmapString(-0.5f, 0.10f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "22-46643-1   -  MD MOSTOFA AL AMIN");
    renderBitmapString(-0.5f, 0.0f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "22-47052-1  - NASRUM SHARON");
